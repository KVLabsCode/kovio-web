  ...
  return (
    <div className="flex min-h-screen bg-bg">
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        <div className="sticky top-0 z-30 flex items-center justify-between gap-5 border-b border-line bg-bg/85 px-9 py-[18px] backdrop-blur-md backdrop-saturate-150">
          ...
          {action ? <div className="flex items-center gap-3.5">{action}</div> : null}
        </div>
